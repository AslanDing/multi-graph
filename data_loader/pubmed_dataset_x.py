...
class PubMedDataset(Dataset):
    def __init__(self,mode='train',k = [16,8],k1 = [16,8],
        ...
        self.GENE_dim = self.feature0.shape[1]
        self.DISEASE_dim = self.feature1.shape[1]
        self.CHEMICAL_dim = self.feature2.shape[1]
        self.SPECIES_dim = self.feature3.shape[1]
    ...
    def get(self, item):
        ...
        A11sub = (self.A11*edge_matrix)[:,domain1_idx]
        ...
        A00sub = (self.A00*edge_matrix)[ :,domain0_idx]
        ...
        A22sub = (self.A22*edge_matrix)[ :,domain2_idx]
        ...
        A33sub = (self.A33*edge_matrix)[ :,domain3_idx]
...
if __name__=="__main__":
    ...
    train_dataset =  PubMedDataset('train')
